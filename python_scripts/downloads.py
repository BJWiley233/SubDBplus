...
# -*- coding: utf-8 -*-
"""
Created on Sat Sep 12 03:43:52 2020
...
if __name__ == '__main__':
    ...
    You can get each JSON with this
    gene_symb into 
        https://amp.pharm.mssm.edu/Harmonizome/api/1.0/gene_set/PIK3CA/PhosphoSitePlus+Substrates+of+Kinases
    
    https://amp.pharm.mssm.edu/Harmonizome/api/1.0/gene_set/%s/PhosphoSitePlus+Substrates+of+Kinases % gene_symb
    '''
    download_datasets([
